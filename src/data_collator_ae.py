...
@dataclass
class DataCollatorForAttributeExtraction(DataCollatorForWholeWordMask):
    """
    ...
    def torch_call(self, examples: List[Union[List[int], Any, Dict[str, Any]]]) -> Dict[str, Any]:
        ...
        labels = [[8 if ll == -100 else ll for ll in l] for l in labels]
        input_ids = _torch_collate_batch(input_ids, self.tokenizer, pad_to_multiple_of=self.pad_to_multiple_of)
        labels = _torch_collate_batch(labels, self.tokenizer, pad_to_multiple_of=self.pad_to_multiple_of)
